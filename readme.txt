...
== Changelog ==
= 1.3.1 =
* Стала точнее считаться статистика
* Изменен способ загрузки плагина

= 1.3 =
* Главред больше не ломает HTML разметку в тех случаях, когда внутри тегов есть текст на русском языке
* Цветные метки у оценок
